    ...
    auth.verifyPhoneNumber(
        ...
        codeSent: (String verificationId,int? token) async {
          ...
          await Navigator.of(context).push(
              MaterialPageRoute(builder: (ctx) => LoginVerification(
      ...
      child: !isLoading?Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                SizedBox(height: MediaQuery.of(context).size.longestSide*0.02,),
                IntlPhoneField(
                  ...
                  flagsButtonMargin: const EdgeInsets.fromLTRB(30, 6, 10, 0),
                  ...
                  children: [
                    GradientButton(
                      ...
                      onTap: () async {
                        ...
                        String phoneNumber = '+$dialCode${mobileNumberController.text}';
